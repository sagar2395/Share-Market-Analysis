...
User-facing guides — written for **you as the user**, not as a developer. Each one
explains what a feature does, how to open it, how to read its output, and what
decision it helps you make. If you're ever stuck in the app, start here.
